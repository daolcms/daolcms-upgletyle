<?php
     ...
     * @brief  Upgletyle(upgletyle) 모듈의 기본 언어팩
     **/

    $lang->upgletyle = 'Upgletyle';
    $lang->about_upgletyle = 'Upgletyle은 XpressEngine의 블로그 전문 모듈입니다.';
    $lang->msg_requried_version = "Upgletyle은 XE코어 %s 버전 이상에서 동작합니다.";

	$lang->cmd_open_id = '오픈 아이디 로그인';
	$lang->cmd_common_id = '일반 아이디 로그인';
	$lang->msg_create_upgletyle = '업글타일 생성이 되었습니다';
	$lang->init_category_title = '기본 카테고리';
	$lang->add_category = '카테고리 추가';
    $lang->upgletyle_admin = 'Upgletyle 관리자';
    $lang->upgletyle_title = 'Upgletyle 제목';
    ...
    $lang->upgletyle_summary = '블로그 요약정보';
    $lang->item_unit = '개';
    ...
    $lang->about_upgletyle_editor = '단락별 편집 방식의 글쓰기 도구 입니다.';
	...
	$lang->cmd_upgletyle_blogapi_service = 'Blog API 서비스 편집';
    ...
    $lang->upgletyle_password1 = '새 비밀번호';
    $lang->upgletyle_password2 = '새 비밀번호 확인';
    ...
    $lang->about_blog_api = '업글타일로 작성한 글을 BlogAPI를 이용하여 다른 블로그 또는 게시판등에 동시 발행/ 수정/ 삭제할 수 있습니다<br/>지원하는 BlogAPI는 MetaWebLog 뿐이며 다른 API는 곧 지원할 수 있도록 하겠습니다<br/>업글타일이 설치된 서버설정에 따라 BlogAPI 이용이 제한될 수 있습니다';
	...
	$lang->success_saved_published = '저장 후 발행되었습니다.';
    ...
    $lang->upgletyle_first_menus = array(
        array('dispUpgletyleToolDashboard','알림판'),
        array('','글관리'),
        array('','대화관리'),
        array('','통계'),
        array('','플러그인'),
    ...
    $lang->upgletyle_second_menus = array(
        array(),
        array(
            'dispUpgletyleToolPostManageWrite'=>'새글 쓰기',
            'dispUpgletyleToolPostManageList'=>'글 목록',
            'dispUpgletyleToolPostManageDeposit'=>'글감보관함',
            'dispUpgletyleToolPostManageCategory'=>'카테고리',
            'dispUpgletyleToolPostManageTag'=>'태그 관리',
            'dispUpgletyleToolPostManageBasket'=>'휴지통',
        ),
        array(
            'dispUpgletyleToolCommunicationComment'=>'댓글',
            'dispUpgletyleToolCommunicationGuestbook'=>'방명록',
            'dispUpgletyleToolCommunicationTrackback'=>'엮인글',
            'dispUpgletyleToolCommunicationSpam'=>'스팸 차단',
        ),
        array(
            'dispUpgletyleToolStatisticsVisitor'=>'방문자',
            'dispUpgletyleToolStatisticsVisitRoute'=>'방문경로',
            'dispUpgletyleToolStatisticsSupporter'=>'지지자',
    ...
    $lang->msg_select_skin = '선택하신 스킨으로 Upgletyle 스킨을 변경합니다.\n\n지금 사용하시는 스킨 정보가 사라집니다.\n\n바꾸시겠습니까? ';
    ...
    $lang->sample_title = '업글타일의 세계로 오신것을 환영합니다!';
    $lang->sample_tags = 'upgletyle ,  업글타일 ,  업글타일에디터 ,  글감수집기';
    $lang->msg_preparation = '준비중입니다';
    $lang->msg_not_user = '해당 사용자가 없습니다.';
    $lang->success_upgletyle_init = '업글타일을 초기화 하였습니다.';
	$lang->upgletyle_init = '초기화';
    $lang->cmd_upgletyle_init = '업글타일을 초기화 합니다.';
    $lang->msg_upgletyle_init_about = '포스트/댓글/트랙백, 방명록, 레이아웃 정보를 모두 삭제 및 초기화를 합니다. 초기화 후 복구는 불가능 합니다.';
    $lang->msg_confirm_upgletyle_init = '초기화를 하시겠습니까?';

	$lang->upgletyle_skin_userimage = '사용자 이미지';
	$lang->msg_check_userimage = 'gif, png, jpg, swf 파일만 가능합니다.';
    $lang->cmd_upgletyle_skin_export = '스킨 백업';
    $lang->upgletyle_skin_import = '스킨 복원';
    $lang->about_upgletyle_skin_import = '로컬 폴더에 있는 사용자 정의 스킨을 원격으로 업로드 합니다. 현재 스킨은 삭제됩니다.';

	$lang->success_upload = '업로드 되었습니다.';
	$lang->cmd_upgletyle_export_request ='백업신청내역';
	$lang->upgletyle_export_recode = '백업신청내역';
	$lang->upgletyle_export_waiting = '신청중';
	$lang->upgletyle_export_request = '백업신청하기';
	$lang->upgletyle_export_type = '데이타 타입';
	$lang->upgletyle_export_date = '데이타 생성시간';
	$lang->upgletyle_export_file = '데이타 파일';
	$lang->cmd_upgletyle_export_file = '내보내기';

	$lang->menu_name = '메뉴명';
	$lang->msg_module_count_exceed = '추가 가능한 해당 모듈 수를 초과 하였습니다.';
	$lang->msg_limit_module = '%s개 남음';
    $lang->about_upgletyle_extra_menu = 'XpressEngine에 설치된 모듈을 업글타일 메뉴로 추가할 수 있습니다.';
    $lang->cmd_textyle_extra_menu_config = '추가메뉴 설정';
    $lang->textyle_extra_menu_limit_count = '최대 생성 수';
    $lang->msg_limit_upgletyle_extra_mid ='영문+[영문+숫자+_] 만 가능합니다.';

	$lang->msg_microblog_setup = '마이크로블로그에 동시 발행을 원하시면 %s을 먼저 해야 합니다.';
	$lang->config_edit_components = '에디터 콤포넌트 설정';
	$lang->upgletyle_bug_report = '오류신고';
